...
import nuxt_plugin_slickcarousel_730b46eb from 'nuxt_plugin_slickcarousel_730b46eb' // Source: ../plugins/slick-carousel (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_62c21662 === 'function') {
    await nuxt_plugin_plugin_62c21662(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_0cce197f === 'function') {
    await nuxt_plugin_plugin_0cce197f(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_slickcarousel_730b46eb === 'function') {
    await nuxt_plugin_slickcarousel_730b46eb(app.context, inject)
  }
